...
MG_ShowAboutDlg()
{
	...
	Gui, MGW_About:Add, Picture, 1, %MG_Icon%
	...
	Gui, MGW_About:Add, Text, xs+8 y+4,  Copyright (C) 2011-2017 Pyonkichi
 ...
 MGW_AboutWebsite:
 MGW_AboutContact:
	local url := "http://hp.vector.co.jp/authors/VA018351/" (MG_Language="Japanese" ? "" : "en/") "mglahk.html"
		, email := "mailto:Pyonkichi<pyonky_claunch@yahoo.co.jp>?subject=About MouseGestureL.ahk"
	Run, % (A_ThisLabel="MGW_AboutWebsite") ? url : email
