...
[RB_]
G=RB_
Default=;Activate Window<MG_CR>IfWinNotActive<MG_CR>{		WinActivate<MG_CR>}
...
ME_LngText209 = Distance from Cursor:`n( -1 as Stay in Origin)
...
ME_LngText312 = Distance from Cursor:`n( -1 as Stay in Origin)
...
ME_LngText455 = Limit of Height (0 as No Limit):
ME_LngText501 = Width:
...
ME_LngCheckBox014 = Draw Trail into Overwrapped Window
