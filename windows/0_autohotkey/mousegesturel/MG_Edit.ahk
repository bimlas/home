...
CreateTargetsTab()
{
	...
	Gui, MEW_Main:Add, Text,	x+%ME_ListPad% ys+1 vLabel5 Section, %ME_LngText051%
	...
	Gui, MEW_Main:Add, Text,	xs y+6 w%width% vLabel6 Disabled, %ME_LngText052%
	...
	; Rule value
	Gui, MEW_Main:Add, Text,	xs y+6 w%width% vLabel7 Disabled, %ME_LngText053%
	...
	; Matching method
	Gui, MEW_Main:Add, Text,	xs y+8 w%width% vLabel8 Disabled, %ME_LngText054%
...
CreateGesturesTab()
{
	...
	Gui, MEW_Main:Add, Text,	x+%ME_ListPad% ys+1 vLabel9 Section, %ME_LngText051%
	...
	; Trigger list
	Gui, MEW_Main:Add, Text,	xs y+10 vLabel10 Section, %ME_LngText021%
	...
	; Buttons
	Gui, MEW_Main:Add, Text,	xs y+3 vLabel11 Section, %ME_LngText022%
	...
	Gui, MEW_Main:Add, Text, x+2 yp h16 vLabel12, %ME_LngText025%
	Gui, MEW_Main:Add, ListBox, xs y+6 w%width% h16 vLBDefAction gLBDefActionSelect AltSubmit

	; Target prioritie list
	height := ME_ListH - 46
	Gui, MEW_Main:Add, Text, xs y+8 h16 vLabel13, %ME_LngText003%
...
CreateRecognitionTab()
{
	...
	Gui, MEW_Main:Add, Text,xs+12 y+8 w%width% vLabel14, %ME_LngText100%
	...
	Gui, MEW_Main:Add, Text,xs+12 yp+18 w%width%  vLabel15, %ME_LngText101%
	Gui, MEW_Main:Add, Edit,x+2 w48 vConfig_Threshold
	Gui, MEW_Main:Add, UpDown, Range0-1000 128

	Gui, MEW_Main:Add, Text,xs+12 y+6 w%width%  vLabel16, %ME_LngText102%
	Gui, MEW_Main:Add, Edit,x+2 w48 vConfig_LongThresholdX
	Gui, MEW_Main:Add, UpDown, Range0-10000 128

	Gui, MEW_Main:Add, Text,xs+12 y+6 w%width%  vLabel17, %ME_LngText103%
	Gui, MEW_Main:Add, Edit,x+2 w48  vConfig_LongThresholdY
	Gui, MEW_Main:Add, UpDown, Range0-10000 128

	Gui, MEW_Main:Add, Text,xs+12 y+6 w%width%  vLabel18,%ME_LngText104%
	...
	Gui, MEW_Main:Add, Text,xs+12 yp+22 w96 vLabel19,%ME_LngText105%
	...
	Gui, MEW_Main:Add, Text,xs+12 y+12 w96 vLabel20,%ME_LngText106%
	Gui, MEW_Main:Add, DropDownList,x+0 w41 vConfig_ORangeA Choose%Config_ORangeA% AltSubmit,0`n30`n45`n60`n90
	Config_ORangeA:=""

	Gui, MEW_Main:Add, Text,xs+12 y+12 w96 vLabel21,%ME_LngText107%
	...
	Gui, MEW_Main:Add, Text,xs+12 yp+18 w%width% vLabel22,%ME_LngText108%
	Gui, MEW_Main:Add, Edit,x+2 w48 vConfig_TimeoutThreshold
	Gui, MEW_Main:Add, UpDown, Range0-1000 128

	Gui, MEW_Main:Add, Text,xs+12 y+6 w%width% vLabel23,%ME_LngText109%
	Gui, MEW_Main:Add, Edit,x+2 w48 vConfig_Timeout
	Gui, MEW_Main:Add, UpDown, Range0-10000 128

	Gui, MEW_Main:Add, Text,xs+12 y+6 w%width% vLabel24,%ME_LngText110%
	...
	Gui, MEW_Main:Add, Text,xs+12 yp+18 vLabel25, %ME_LngText111%
	Gui, MEW_Main:Add, Edit,x+16 w48 vConfig_EdgeInterval
	Gui, MEW_Main:Add, UpDown, Range0-10000 128

	Gui, MEW_Main:Add, Text,xs+12 y+2 w140  vLabel26, %ME_LngText112%
	Gui, MEW_Main:Add, Text,xs+12 y+10 w65 Right vLabel27, %ME_LngText113%
	Gui, MEW_Main:Add, Edit,x+6 w48 vConfig_CornerX
	Gui, MEW_Main:Add, UpDown, Range1-10000 128

	Gui, MEW_Main:Add, Text,x+12 yp Right vLabel28, %ME_LngText114%
...
CreateHintsTab()
{
	...
	Gui, MEW_Main:Add, Text,xs+12 y+10 vLabel29, %ME_LngText200%
	...
	Gui, MEW_Main:Add, Text,xs+229 ys+16 w155 vLabel30, %ME_LngText201%
	Gui, MEW_Main:Add, Edit,x+0 w48 vConfig_NaviInterval
	Gui, MEW_Main:Add, UpDown, Range0-10000 128

	Gui, MEW_Main:Add, Text,xs+229 y+6 w155  vLabel31, %ME_LngText202%
...
CreateTrailTab()
{
	...
	Gui, MEW_Main:Add, Text,xs+24 y+10 vLabel59, %ME_LngText306%
	...
	Gui, MEW_Main:Add, Text,xs+14 y+6 w60 Right vLabel60, %ME_LngText421%
	Gui, MEW_Main:Add, Edit,x+10 w48 vConfig_LogPosX
	Gui, MEW_Main:Add, UpDown, Range1-10000 128 vUDLogPosX

	Gui, MEW_Main:Add, Text,x+11 yp Right vLabel61, %ME_LngText422%
...
CreateOthersTab()
{
	...
	Gui, MEW_Main:Add, Text,xs+12 yp+20 w%width% vLabel70,%ME_LngText451%
	Gui, MEW_Main:Add, Hotkey,x+0 w%width2% vConfig_HotkeyEnable gOnHotkeyChange

	Gui, MEW_Main:Add, Text,xs+12 y+8 w%width% vLabel71,%ME_LngText452%
	...
	Gui, MEW_Main:Add, Text,xs+40 y+6 vLabel74, %ME_LngText455%
...
AdjustDialogHeight(bAdjPos=false)
{
	...
	static tblY := [ "Label3", "BAddAction", "BUpdateAction", "EAction"
				   ...
				   , "DDLLogic", "BAddRule", "BUpdateRule", "Label6", "DDLRuleType"
				   , "BRulePicker", "Label7", "ERuleValue", "BClearRule", "Label8"
				   ...
				   , "GesturePatternBox", "BClearGesture", "Label10", "LBButtons"
				   , "BAddTrigger", "Label11"
...
On8DirChange(bConvert=true)
{
	...
	GuiControl, MEW_Main:%stat%, Label21
...
OnNaviPosChange:
	...
	GuiControl, MEW_Main:%stat%, Label53
...
EnableRuleControls()
{
	...
	GuiControl, MEW_Main:Enable, Label6
...
UpdateRuleCtrlStat(fModify=false)
{
	...
	GuiControl, MEW_Main:%stat%, Label8
