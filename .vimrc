...
" ============================================================================
"
" __ HELP _______________________________
"
" Ahol mukodik a <Tab> completion, ott hasznalhatjuk a <C-D> kombinaciot az
" osszes lehetoseg kilistazasara.
"
" Az 'str' sztringet tartalmazo fuggvenynevek keresese:
"   :help str*(<C-D>
"
" Hasznos sugok:
"   :help quickref              A hasznalhato parancsok listaja.
"   :help index                 Az osszes parancs listaja.
"   :help functions             Osszes fuggveny listaja.
"   :help *-functions<C-D>      Fuggvenyek listaja tematikusan.
"
" Script segitseg:
"   :help eval                  Expression evaluation (szintaxis)
"   :help usr_41.txt            Write a Vim script
"   :help g@                    Visual-block hasznalata szkriptekben.
"
" Nagyon sok tipp:
"   http://vimdoc.sourceforge.net/htmldoc/vimfaq.html
"
" Helptags ujrageneralasa:
"   :helptags ~/.vim/doc
"
" PYTHON SUPPORT:
" Ha win-en nem mukodik a python support, akkor a
"   :version
" kimeneteben keresd meg, hogy melyik python verzioval lett a vim leforditva,
" ugyanis csak ezt a verziot tamogatja. Pl.:
"   -DDYNAMIC_PYTHON_DLL=\"python27.dll\"
"   -DDYNAMIC_PYTHON3_DLL=\"python31.dll\"
" Ha csak portable python-t tudsz hasznalni, ne felejtsd el ezt is betenni a
" vimrc-be, ugyanis ezek nelkul hibaval fog kilepni a vim:
...
"
" dtd2vim - dtd-bol omni completion (pl. docbook-hoz hasznos)
"   http://www.vim.org/scripts/script.php?script_id=1462
"   https://github.com/vim-scripts/dtd2vim.git

"                                  PLUGINOK                               {{{2
" ____________________________________________________________________________
"
" FIGYELEM: Eleg csak a vundle plugint feltenni, a tobbi konnyeden telepitheto
" a segitsegevel.
"
" .vba, vagy .vmb (vimball) plugin telepitese:
"   :set fileformats=unix
"   :so %
"
" ... eltavolitasa:
"   :RmVimball PLUGIN_NEVE
" A plugin nevet a .vimballrecord fajbol kereshetjuk ki.
"
" ... letrehozasahoz egy fajlba irjuk bele a vimball-ba tartozo fajlok
" utvonalat, pl.:
"   doc/help.txt
"   plugin/script.vim
" ... majd:
"   :% MkVimball PLUGIN_NEVE .
"
" DrChip egy halom plugin atyja. Respect!
"   http://www.drchip.org/astronaut/vim/
"
" vundle - plugin-ok automatizalt telepitese git-en keresztul (is)
"   http://www.vim.org/scripts/script.php?script_id=3458
"   https://github.com/gmarik/vundle.git
"
"   A csomagok telepitesehez :PluginInstall PLUGIN_NEVE
"   Pl.: PluginInstall tpope/vim-fugitive
"   Igy anelkul telepithetjuk, hogy kezzel kellene letoltenunk.
"
"   A :PluginList parancsai:
"
...
"
"   A plugin-ok frissitesehez a :PluginUpdate parancsot hasznaljuk, utanna az
"   'u' megnyomasaval kiirja a valtoztatasokat.
"
"   A ~/.vim/bundle konyvtarba tolti le a csomagokat Win-en is.
"
" locator - info a kurzor poziciojaraol (fold, fuggveny, osztaly)
"   http://www.vim.org/scripts/script.php?script_id=4166
"   https://github.com/vim-scripts/locator.git
"
" solarized - nagyon szep colorscheme (light es dark is)
"   https://github.com/altercation/vim-colors-solarized
"
" lightline - divatos, de minimalista statusline
"   https://github.com/itchyny/lightline.vim.git
"
" vis - visual block-on hajthatod vegre kedvenc parancsaidat
"   http://www.vim.org/scripts/script.php?script_id=1195
"   https://github.com/vim-scripts/vis.git
"
" align - szoveg igazitasa kulonbozo jelekhez (=, :, kommentek, stb.)
"   http://www.vim.org/scripts/script.php?script_id=294
"   https://github.com/vim-scripts/Align.git
"
" easygrep - grep, replace a fajlokon, buffereken
"   http://www.vim.org/scripts/script.php?script_id=2438
"   https://github.com/vim-scripts/EasyGrep.git
"
" numutils - szamok manipulalasa regex tamogatassal
"   http://www.vim.org/scripts/script.php?script_id=4634
"   https://github.com/vim-scripts/NumUtils.git
"
" __ PROGRAMOZAS ____________________________
"
...
"
" nerdcommenter - szovegreszek kommentelese (akar oszlopok is)
"   http://www.vim.org/scripts/script.php?script_id=1218
"   https://github.com/scrooloose/nerdcommenter.git
"
" omnicppcomplete - automatikus kodkiegeszites (jobb, mint a beepitett)
"   http://www.vim.org/scripts/script.php?script_id=1520
"   https://github.com/FromtonRouge/OmniCppComplete.git
"
" tagbar - a fajlban talalhato tagok listaja
"   http://www.vim.org/scripts/script.php?script_id=3465
"   https://github.com/majutsushi/tagbar.git
"
" pydoc - pydoc elerese a K lenyomasaval
"   http://www.vim.org/scripts/script.php?script_id=910
"   https://github.com/fs111/pydoc.vim
"
" __ GIT ____________________________________
"
" fugitive - git integracio (ne felejtsd el a 'map y' reszt torolni)
"   http://www.vim.org/scripts/script.php?script_id=2975
"   https://github.com/tpope/vim-fugitive.git
"
"   Erzekenyen erinti a &directory (minden swapfile-nak egy konyvtarban kell
"   lennie) es az &autochdir (ftp-n meghulyul, ha be van kapcsolva).
"
" gitv - gitk a vim-en belul
"   http://www.vim.org/scripts/script.php?script_id=3574
"   https://github.com/gregsexton/gitv.git
"
"   A :Gitv! split-tel nyit egy ablakot, ami az aktualis fajlhoz tartozo
"   commit-okat listazza ki es a parancsok is csak arra lesznek ervenyesek
"   (pl. checkout a fajlt fogja erinteni, nem a repot), a :Gitv pedig egy gitk
"   szeru tab-ot nyit meg, ahol a repo-val kapcsolatos utasitasokat adhatjuk
"   ki.
"
"   Mod Parancs
"
"   n   a       osszes branch megjelenitese
"   n   Enter   megnyitja a commit-olt valtozatot
"   n   s       vsplit-ben megnyitja a commit-olt valtozatot
"   nv  D       splitdiff a jelenlegi fajllal, visual-ban a kijeloles teteje
"               es alja kozti kulonbseget mutatja meg
"   n   i       commit uzenet es a valtoztatasok listaja
"   nv  S       stat a valtoztatasokrol, visual-ban a kijelolt commit-okban
"               vegzett osszes valtoztatasrol
"   n   co      checkout
"   n   \m      merge a HEAD-hez
"   v   m       merge a kijeloles tetejet az aljahoz
"   n   u       lista frissitese
"   n   q       kilepes
"
" git-cheat - git help
"   http://www.vim.org/scripts/script.php?script_id=2744
"   https://github.com/vim-scripts/git-cheat.git
"
" __ BLACKLIST __________________________
"
" buffersaurus - kereses a bufferekben nagyon profi modon
"   http://www.vim.org/scripts/script.php?script_id=3620
"   https://github.com/jeetsukumaran/vim-buffersaurus.git
"
"   Nem lehet visszavonni a replace-t; nem lehet ures sztringre cserelni a
"   talalatokat.
"
" hypergit - extra git parancsok
"   http://www.vim.org/scripts/script.php?script_id=2954
"   https://github.com/c9s/hypergit.vim
"
"   Win-en bug-os, linux-on nem probaltam.
"
" minibufexplorer - bufferek listaja az ablak tetejen
"   http://www.vim.org/scripts/script.php?script_id=159
"   https://github.com/vim-scripts/minibufexplorerpp.git
"
"   Ha tobb fajl van megnyitva es az egyikbol a :wq utasitassal akarok
"   kilepni, akkor a buffexpl ablak miatt nem lehet. A
"   g:miniBufExplorerMoreThanOne buheralasanal merult fel a problema, ha 1-re
"   van allitva, nem merul fel ez a hiba, de muszaly, hogy ez a valtozo 0
"   legyen, kulonben keretlen ablakokat nyit meg neha.
"
" nerdtree - fajlbongeszo, egyszerubb, mint a netrw
"   http://www.vim.org/scripts/script.php?script_id=1658
"   https://github.com/scrooloose/nerdtree
"
"   Nincs vele semmi baj, csak ftp-n nem lehet hasznalni, ezert felesleges.

"                                 IRANYITAS                               {{{2
" ____________________________________________________________________________
"
" fX FX     Kovetkezo / elozo 'X'-re ugras.
" w  b      Kovetkezo / elozo szo elejere ugras.
" W  B      ... szokozokkel elvalasztott szo.
" e  ge     ... vegere.
" E  gE
" )  (      ... mondat.
" }  {      ... paragrafus.
" ]] [[     ... bekezdes.
" '.        Az utoljara valtoztatott sorra ugras.
"
" __ INSERT MOD _________________________
"
" <C-Y>     Szoveg masolasa az egyel feljebb levo sorbol.
" <C-E>     ... lejjeb levo sorbol.
" <C-A>     Utoljara beirt szoveg ismetlese. (ne lepj ki az insert modbol)
" <C-O>     Egy parancs kiadasa normal modban, majd vissza insert-be.
" <C-V>     Specialis gomb (pl.: <leftmouse>), vagy ascii kod alapjan karakter
"           beszurasa. (:help i_CTRL-V)
" <C-R>     Regiszter tartalmanak, vagy ha a regiszter helyett = jelet utunk,
"           akkor a beirt kifejezes visszateresi ertekenek beillesztese.
"           (:help i_CTRL-R)
" <C-K>     Digraph beszurasa. A :digraphs parancs, vagy a :help digraph-table
"           kilistazza a lehetseges karaktereket. Pl.:
"           ø   o/
"           °   DG
"
" __ VISUAL MOD _________________________
"
" o         A kijyeloles masik vegehez ugras.
" Iszoveg   Visual-block minden sora ele illessze be a szoveget. (torles es
"           mozgas nem mukodik vele)
" Aszoveg   ... minden sor vegere.
" cszoveg   ... a kijelolt szoveget a beirt szovegre csereli.
" Cszoveg   ... minden soranak veget eltorli, a beirt szoveget hozzafuzi.
" !parancs  A kijelolt szoveget egy kulso program bemenetere kuldi. (pl.: sed)
"
" __ NORMAL MOD _________________________
"
" #<C-A>    Beirt # ertek hozzaadasa a kurzor alatti szamhoz.
" #<C-X>    ... kivonasa.
"
" __ NORMAL MOD PARANCSOK _______________
"
" zz zb zt  A kurzor legyen az ablak kozepen, aljan, tetejen.
" *         Kurzor alatti szo kovetkezo talalatara ugras.
" g*        ... azokat is talalja meg, mikor egy masik szo reszekent szerepel.
" ga        Kurzor alatti karakter ascii kodjai.
" g8        Utf-8 karakter byte-jainak hexadecimalis ertekei.
"
" __ ABLAKKEZELES _______________________
"
" <C-W>=    Ablakok azonos szelessegel.
" #<C-W>_   Ablak atmeretezese # sor magassagura.
" #<C-W>|   Ablak atmeretezese # karakter szelessegure.
"
" <C-W>r    Ablakok felcserelese / forgatasa.
" <C-W>K    Vertikális -> horizontális split.
" <C-W>H    Horizontális -> vertikális split.
"
" __ SZOVEG OBJEKTUMOK __________________
"
" :help text-objects
"
" A legegyszerubb modon ugy erthetjuk meg, hogy mi mit jelol, ha kijeloles
" parameterekent hasznaljuk (v), de az operatorok mindegyikevel mukodnek.
" (:help operator)
"
" vaw       Egy szo kijelolese. (az utanna allo szokozt is kijeloli)
" vaW       ... ami szokozokkel van elkulonitve.
" viw viW   ... az utanna allo szokoz nelkul.
" vas vis   ... mondat.
" vap vip   ... paragrafus.
" vat vit   Xml tagokkal kozrezart blokk. (pl.: <body> es </body>)
" vab vib   ... ( es ) jelekkel kozrezart blokk.
" vaB viB   ... { es } jelekkel.
" va> vi>   ... < es > jelekkel.
" va' vi'   Innentol szerintem egyertelmu.
" va" vi"
" va` vi`
...
"
" Bovebb info:
"   :help cmdline-ranges        Segitseg a range-ekhez.
"   :help pattern-overview      Regex kifejezesek
"   :help sub-replace-special   Substitute {string} reszeben hasznalhatoak
"
" __ REGEX ______________________________
"
" Sztring-regex osszehasonlito operatotok (:help expr-!~):
"   =~      A szoveg tartalmazza a regex kifejezest. (pl. '^[0-9]$', ha csak
"           szamokat szabad tartalmaznia)
"   !~      ... nem tartalmazza.
"
" Legkissebb egyezes:
"   :s/.\{-} *#/shell script parancsok kommenttel/
"
" Substitute tobb soros mintakon (:help \_x):
"   :s/kezdet\_.\{-}vege/helyettesites/
"
" Zero-width positive look ahead:
" Az adott szoveg UTAN SZEREPELNIE KELL a kifejezesnek, de nem lesz a talalat
" resze. Pl. az 'ABC'-bol 'abC' lesz, de az 'AB'-ra nem lesz talalat, igy
" modositas sem:
"   :s/AB\(C\)\@=/\L&/
" Mindenkepp valami UTAN kell, hogy alljon, az 's/\(A\)@=BC/\L&/' nem mukodik!
"
" Zero-width negative look ahead:
" Az adott szoveg UTAN NEM ALLHAT a kifejezes, pl. az 'ABC'-t nem fogja
" kisbetusse tenni, csak az 'AB'-t:
"   :s/AB\(C\)\@!/\L&/
" Ha kiprobaljuk az ':s/\(A\)\@!BC/\L&/' utasitast, 'Abc'-t kapunk.
"
" Zero-width positive look behind:
" Az 'A'-nak szerepelnie kell a 'BC' elott:
"   :s/\(A\)\@<=BC/\L&/
" Az 's/AB\(C\)\@<=/\L&/' nem mukodik.
"
" Zero-width negative look behind:
" Az 'A' nem allhat a 'BC' elott:
"   :s/\(A\)\@<!BC/\L&/
" Az ':s/AB\(C\)\@<!/\L&/' utasitas eredmenye 'abC'.
"
" Osszesitve a fentieket itt egy pelda, ami a 'Netto 1234.5 Ft' sorbol olvassa
" be egy valtozoba az 1234.5 erteket:
"   let f = str2float(matchstr(getline(line('.')), '\(Netto \)\@<=.\{-}\( Ft\)\@='))
"
" Szamertek keresese es modositasa:
"   :s:\([0-9]\+\)Ft:\= submatch(0) . ' = ' . (submatch(1) * 253) . 'Euro':
"
" __ PELDA ____________________________
"
" Az alabbi peldakhoz egy fajlba mentsuk ki ezeket a sorokat:
"
"   1 FOCIM
"   2 START
"   3   elso blokk sora
...
"   5 ALCIM
"   6 START
"   7   masodik blokk sora
"   8 STOP
"
" A parancs, amit a kulonbozo peldakon lehet kiprobalni ki fogja irni a
" vegrehajtas sorrendjet es a range kezdo es zaro soranak szamat
" (SORREND:KEZDO,ZARO):
"   command -range Cmd <line1>,<line2>s/.*/\=printf("%s (%d:%d,%d)",
"                     \ submatch(0), i, <line1>, <line2>)/ | let i = i + 1
"
" Minden pelda elott nullazzuk az 'i' valtozot:
"   let i = 0
"
" Probalgassuk, hogy ha kulonbozo helyekrol adjuk ki az utasitast, hogy fog
" reagalni a program es nezzuk meg a kulonbseget a 'mezei' range es a :g
" kozott.
"
" __ RANGE ______________________________
"
" Az 50-100 sorokban keressuk a REGEX-et:
"   /\%>50l\%<100lREGEX/
"
" A 2-4 sorokon hajtsa vegre a PARANCS-ot
"   :2,4 PARANCS
"
" Parancs vegrehajtasa a kurzor utani | elotti elso REGEX-re illeszkedo soron:
"   :/REGEX/ PARANCS | :?REGEX? PARANCS
"
" A talalat utani soron hajtson vegre parancsokat:
"   :/REGEX/+1 PARANCS
"
...
"   :2;/STOP/ PARANCS
"
" __ GLOBAL _____________________________
"
" Parancs vegrehajtasa az egesz fajlban a regex-re illeszkedo | nem illeszkedo
" sorokon:
"   :g/REGEX/ PARANCS | :v/REGEX/ PARANCS
"   :g/FOCIM/ /ALCIM/ PARANCS
"   ...
"
" FIGYELEM: a :g es :v utasitasokat SOSE hasznaljuk osszecsukott fold-ok
" mellett!!!
"
...
" megall!
"
" Fontos, hogy mindenkepp elkulonitheto legyen a START es a STOP, pl. '.html'
" fajlokban a PRE tagok kozotti reszekhez ezt hasznaljunk:
"   :g/[^/]PRE/;/\/PRE/ PARANCS
"
" Ha nem igy teszunk, akkor jo nagy kulimajsz lesz a vege. A :v nem mindig
" adja a :g ellentetet, ezert inkabb :g-vel jeloljuk meg a sorokat (pl. egy ;
" elhelyezesevel a sor elejen), amiket ki szeretnenk hagyni, majd ismet adjuk
" ki a :g parancsot a jelolo tagadasaval. (pl :g/^[^;]/)

"                       RITKAN HASZNALT HASZNOS DOLGOK                    {{{2
" ____________________________________________________________________________
"
...
"   vim --startuptime 'log.txt'     Profiling.
"
" __ HISTORY, MESSAGES, STB. ____________
"
" Uzenetek visszatekintese:
"   :messages
"
" History-k megtekintese / szerkesztese - jol jon, ha pl. egy hosszu parancsot
" akarunk kimasolni, hogy feljegyezhessuk magunknak:
"   q:      Command-history
"   q/ q?   Search-history
"
...
"
" __ BEALLITASOK ________________________
"
...
"   :set virtualedit=all
"
" __ FAJL BEALLITASAI ___________________
"
" Fajl (ujra)megnyitasa adott beallitasokkal (:help ++opt):
"   :edit ++encoding=utf-8 [FAJL]
"
" Ne irjon ujsor karaktert a fajl vegere:
"   :set binary noendofline
"
" __ FAJL MODOSITASA ____________________
"
...
"   :diffget
"
" __ SZINKRONIZALT ABLAKOK ______________
"
" Ha nem diff-ben szeretnenk ket fajlt szinkronban megtekinteni, akkor mindket
" ablakban adjuk ki a kovetkezo utasitast:
"   :set scrollbind cursorbind
" Hogy az ablakok ugyanazt a sort mutassak:
"   :syncbind
"
" __ SCRIPT _____________________________
"
" String -> Float:
...
"
" Sztring hosszanak megallapitasahoz ne a len() fuggvenyt hasznald, mert az a
" bajtokat szamolja, hanem ezt:
"   strdisplaywidth( 'ekezetes szoveg' )
"
" __ EGYEBEK ____________________________
"
...
"   :earlier 1f
"
" Ha parancsokat akarunk vegrehajtani egy fajlbol (pl. ezeket a jegyzeteket),
" jeloljuk ki a kivant reszt, 'y' megnyomasaval kimasoljuk, majd:
"   :@"
"
" Ha map-olunk egy fuggvenyt es nem akarjuk, hogy megjelenjen a 'Press ENTER'
" uzenet, akkor ket <CR>-t rakjunk a vegere:
"
"   map call fgv()<CR><CR>
"
...
" ____________________________________________________________________________
"
" A megfelelo fajlbongeszo kinyitasa: tavoli fajloknal netrw, helyi fajloknal
" nerdtree.

function ToggleBrowser()

  " Ha egy netrw-vel megnyitott (tavoli) fajlban vagyunk, akkor nyissuk meg a
  " bongeszot a fajl konyvtaraban.
